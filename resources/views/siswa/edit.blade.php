        ...
        <h1>Edit data siswa</h1>
            ...
            <form action="/siswa/{{$siswa->id}}/update" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input name="nama belakang" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Nama Belakang" value="{{$siswa->nama_belakang}}">
                            </div>
